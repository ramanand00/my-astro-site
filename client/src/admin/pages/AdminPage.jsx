...
export default function AdminContactPage() {
  ...
  const fetchContacts = async () => {
    try {
      const res = await axios.get("https://my-astro-site-zpfu.vercel.app/api/contact");
  ...
  try {
    const response = await axios.delete(`https://my-astro-site-zpfu.vercel.app/api/contact/${id}`);
